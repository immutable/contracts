...
// Interface
import {IERC165Upgradeable} from "openzeppelin-contracts-upgradeable-4.9.3/utils/introspection/ERC165Upgradeable.sol";
...
abstract contract OperatorAllowlistEnforcedUpgradeable is OperatorAllowlistEnforcementErrors {
    ///     =====   State Variables  =====
