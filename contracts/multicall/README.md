...
---
---
# GuardedMulticaller V1

The GuardedMulticaller V1 contract is no longer recommended for use. For reference purposes, it can be accessed here: [GuardedMulticaller.sol](https://github.com/immutable/contracts/blob/9c9557bfc3a43b4f770d66ef74c68f2d7e001881/contracts/multicall/GuardedMulticaller.sol).
