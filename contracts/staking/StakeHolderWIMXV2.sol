...
/**
 * @title StakeHolderWIMXV2: allows anyone to stake any amount of IMX and to then remove all or part of that stake.
 ...
 * @dev This contract is the same as StakeHolderWIMX, with the exception that it derives from StakeHolderBaseV2.
 */
contract StakeHolderWIMXV2 is StakeHolderNativeV2 {
