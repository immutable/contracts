...
/*
    ...
    an opinionated form of minting. This contract is intended to be inherited and have the `mint`
    function overridden to meet the needs of the inheriting contract.
*/
