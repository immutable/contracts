...
abstract contract ERC721HybridPermit is ERC721Hybrid, Ownable, IERC4494 {
    ...
    constructor(string memory name, string memory symbol) ERC721Hybrid(
        name,
        symbol
    ) {
