...
// Token
import {ERC721PermitV3, ERC721Upgradeable, ERC721BurnableUpgradeable} from "./ERC721PermitV3.sol";

// Allowlist
import {ERC2981Upgradeable} from "openzeppelin-contracts-upgradeable-4.9.3/token/common/ERC2981Upgradeable.sol";

// TODO have upgradeable option
import {OperatorAllowlistEnforcedUpgradeable} from "../../../allowlist/OperatorAllowlistEnforcedUpgradeable.sol";

// Utils
import {BitMapsUpgradeable} from "openzeppelin-contracts-upgradeable-4.9.3/utils/structs/BitMapsUpgradeable.sol";

// TODO upgradeable option
import {AccessControlEnumerableUpgradeable, MintingAccessControlUpgradeable} from "../../../access/MintingAccessControlUpgradeable.sol";
...
abstract contract ImmutableERC721BaseV3 is OperatorAllowlistEnforcedUpgradeable, MintingAccessControlUpgradeable, ERC721PermitV3, ERC2981Upgradeable {
    ...
    BitMapsUpgradeable.BitMap private _burnedTokens;
     ...
     */
    function __ImmutableERC721Base_init(
        address owner_,
        string memory name_,
     ...
     */
    function _approve(address to, uint256 tokenId) internal override(ERC721Upgradeable) validateApproval(to) {
        super._approve(to, tokenId);
    }

    /**
     * @inheritdoc ERC721PermitV3
    ...
    function _transfer(
        ...
        address to,
        uint256 tokenId
    ) internal override(ERC721PermitV3) validateTransfer(from, to) {
    ...
    uint256[50] private __ImmutableERC721BaseGap;
