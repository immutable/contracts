...
contract DeployImmutableSignedZoneV3 is Script {
    ...
    function run() external {
        ...
        address expectedIMMUTABLE_SEAPORT_ADDRESS = create2Deployer.deployedAddress(
        ...
        require(
            expectedIMMUTABLE_SEAPORT_ADDRESS == IMMUTABLE_SEAPORT_ADDRESS, "Expected ImmutableSeaport address mismatch"
        );
        ...
        address expectedZoneAddress = create2Deployer.deployedAddress(
            zoneDeploymentBytecode, ACCESS_CONTROLLED_DEPLOYER_ADDRESS, ZONE_DEPLOYMENT_SALT
        );
