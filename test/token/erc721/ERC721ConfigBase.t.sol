...
abstract contract ERC721ConfigBaseTest is ERC721BaseTest {
    ...
    function testAccessControlForMinting() public {
        ...
        vm.expectRevert(
            "AccessControl: account 0x29e3b139f4393adda86303fcdaa35f60bb7092bf is missing role 0x4d494e5445525f524f4c45000000000000000000000000000000000000000000"
        );
        erc721.mint(user1, 3);
    ...
    function testTokenURIWithBaseURISet() public {
        ...
        assertEq(erc721.tokenURI(tokenId), string(abi.encodePacked(baseURI, vm.toString(tokenId))));
    }
