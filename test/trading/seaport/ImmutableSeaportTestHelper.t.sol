...
abstract contract ImmutableSeaportTestHelper is Test {
    ...
    function _convertConsiderationToReceivedItem(ConsiderationItem[] memory _items)
        internal
        pure
    ...
    function _signOrder(uint256 _signerPkey, bytes32 orderHash, uint64 expiration, bytes memory context)
        internal
        view
