...
| `test_validateSubstandards_substandard1`                                                         | Context with substandard 1.                                                                     | Yes        | Yes         |
...
| `test_validateSubstandard1_returns33OnSuccess`                                                   | Substandard 1 validation when first received item identifier matches expected identifier.       | Yes        | Yes         |
